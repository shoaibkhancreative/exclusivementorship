...
export async function adminSessionMiddleware(c: Context<{ Bindings: Env; Variables: AdminVariables }>, next: Next) {
...
export async function requireAdmin(c: Context<{ Bindings: Env; Variables: AdminVariables }>, next: Next) {
