export function UsersIcon({ className = "h-[18px] w-[18px]" }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className}>
      ...
      <path
        d="M3.5 17c0-3.45 2.9-6 6.5-6s6.5 2.55 6.5 6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function BookIcon({ className = "h-[18px] w-[18px]" }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className}>
      <path
        d="M4 4.5c0-.55.45-1 1-1h4.5v13H5c-.55 0-1-.45-1-1v-11Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M16 4.5c0-.55-.45-1-1-1h-4.5v13H15c.55 0 1-.45 1-1v-11Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export function CoinIcon({ className = "h-[18px] w-[18px]" }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className}>
      ...
      <path
        d="M10 6.5v7M12.2 8.3c0-1-1-1.55-2.2-1.55-1.32 0-2.2.6-2.2 1.5 0 2.2 4.4 1.15 4.4 3.35 0 .95-.98 1.6-2.2 1.6-1.2 0-2.2-.55-2.2-1.55"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
export function DownloadIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className}>
      ...
      />
      <path
        d="M4 14.5v1.2c0 .72.58 1.3 1.3 1.3h9.4c.72 0 1.3-.58 1.3-1.3v-1.2"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function CopyIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className}>
      ...
      <path
        d="M13 7V5.3A1.3 1.3 0 0 0 11.7 4H4.3A1.3 1.3 0 0 0 3 5.3v9.4A1.3 1.3 0 0 0 4.3 16H6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
